...
-- CLIENT COPY
insert into client(email, city, company_name, company_registration_number, is_banned, is_removed, name, surname, password, role, state, street, street_number)
...
-- CONCRETE CAR
insert into concrete_car(concrete_car_id, car_brand_id, car_class_id, car_fuel_type_id, car_model_id, car_transmission_type_id)
...
-- OWNERS CAR
insert into owners_car (id, children_sit_number,client_email, concrete_car_concrete_car_id, is_insurance, travel_distance_constraint , traveled_unit, mileage)
...
values(501, "THE BEST", "2021-05-13 00:00:00", true, null, "2020-05-13 00:00:00", null, null, 201, 301);
insert into advert(id, description, end_of_advert, is_active, profile_picture, start_of_advert, client_email, client_id, owners_car_id, price_id)
