-- -- CLIENT COPY
 insert into client_copy(id, email, city, company_name, company_registration_number,is_creation_enabled, is_banned,is_forbidden_advert, is_removed, name, surname, password, role, state, street, street_number)
 values(101, "pera@com", null, null, null, true, false, false, false, null, null, null, null, null, null, null);
 insert into client_copy(id, email, city, company_name, company_registration_number,is_creation_enabled, is_banned,is_forbidden_advert, is_removed, name, surname, password, role, state, street, street_number)
 values(102, "marko@com", null, null, null, true ,false, false, false, null, null, null, null, null, null, null);
 insert into client_copy(id, email, city, company_name, company_registration_number,is_creation_enabled, is_banned, is_forbidden_advert, is_removed, name, surname, password, role, state, street, street_number)
 values(103, "zika@com", null, null, null, true, false, false , false ,null, null, null, null, null, null, null);
