-- -- CLIENT COPY
 insert into client_copy(id, email, city, company_name, company_registration_number, is_banned,is_forbidden_advert, is_removed, name, surname, password, role, state, street, street_number)
